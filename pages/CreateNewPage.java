...
public class CreateNewPage extends ProjectSpecificMethods{
	...
	public CreateNewPage clickAttachFile() throws InterruptedException {
		...
		Thread.sleep(3000);
		switchToWindow(1);
		clearAndType(locateElement(Locators.ID, "file"), "C:/Users/LD657LH/OneDrive - EY/Documents/salesdem.txt");	
		Thread.sleep(3000);
...
//		Thread.sleep(20000);		
//		switchToWindow(1);
//		clearAndType(locateElement(Locators.NAME, "file"), "C:/Users/LD657LH/OneDrive - EY/Documents/salesdem.txt");	
